...
public class TileEntityRope extends TileEntity
{
    ...
    public void updateEntity()
    {
        if (delay == 0)
        {
            ...
            {
                worldObj.setBlock(xCoord, yCoord - 1, zCoord, SDK_GrapplingHook.blockRope.blockID);
                worldObj.setBlockMetadataWithNotify(xCoord, yCoord - 1, zCoord, worldObj.getBlockMetadata(xCoord, yCoord, zCoord), 0);
                delay--;
            }
        }
        else if (delay > 0)
